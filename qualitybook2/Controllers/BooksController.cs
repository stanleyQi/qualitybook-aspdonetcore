...
namespace qualitybook2.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await qualityBookDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("BookId,BookName,ShortDescription,Description,ImageUrl,Price,Author,PreferredFlag,CategoryId,SupplierId")] Book book)
        {
            ...
            ViewData["SupplierId"] = new SelectList(_context.Suppliers, "SupplierId", "SupplierId", book.SupplierId);
            return View(book);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,BookName,ShortDescription,Description,ImageUrl,Price,Author,PreferredFlag,CategoryId,SupplierId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
